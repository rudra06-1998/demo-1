...
const HireCertifiedEngineers = () => {
  ...
  return (
    <div className="bg-white">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-10">
          ...
          <div>
            ...
            <p className="mt-4 text-gray-600 text-base md:text-lg">
              Lack of hands-on skills and real-world readiness is one of the top
              reasons companies stay vulnerable. A bad hire is no longer just a
              talent issue. It's a security risk.
            </p>
      ...
      <section className="w-full bg-[#0c0c0d] py-19 px-6 md:px-12 lg:px-20">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-10">
          {/* Left Image */}
          ...
          <div>
            <h2 className="text-3xl md:text-4xl font-bold text-white leading-snug">
              A Wrong Hire Won’t <br /> Just Slow Your Team <br /> Down. It’ll
              Put You On <br /> The Line.
            </h2>
            <p className="mt-4 text-gray-300 text-base md:text-lg leading-relaxed">
              One wrong hire does more than miss deadlines. It drains
              high-performing teams, disrupts delivery, and puts leadership in
              the firing line. In critical environments, that ripple becomes a
              wave. The talent shortage is real. But with Global Skills, your
              next hire won’t be a gamble.
            </p>
          </div>
        </div>
      </section>
