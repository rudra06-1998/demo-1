...
const clients = [
  {
    name: "Ericsson",
    logo: "/assets/imgi_4_c7a9764c-611b-480a-90ac-b570304e09ae.png",
  },
  {
    name: "Aramco",
    logo: "/assets/imgi_5_a3046e12-1eca-4986-85da-315d619ba61b.jpg",
  },
  {
    name: "Tata Play",
    logo: "/assets/imgi_6_a1022377-b5ba-4458-9c21-0104a0fa6e59.png",
  },
  {
    name: "Adani",
    logo: "/assets/imgi_7_bcd9ecf6-99b5-4347-92c8-e1dc46bb7f11.png",
  },
  {
    name: "Deloitte",
    logo: "/assets/imgi_14_1ce75568-d5e2-43b0-adb7-7abcea052ab6.png",
  },
  {
    name: "CaixaBank",
    logo: "/assets/imgi_15_f854512b-a3be-4889-8e2e-e357815f23a5.png",
  },
  {
    name: "Inflow",
    logo: "/assets/imgi_16_a08acffb-85dc-488c-b892-baf0573a9981.png",
  },
  {
    name: "Genpact",
    logo: "/assets/imgi_17_b6f76adc-92e8-4e6f-87fb-6e3ff84eae58.png",
  },
];
...
const ContactUs = () => {
  return (
    <div>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="mt-4 text-gray-600 leading-relaxed">
              We’d love to understand your requirements. Share a few quick
              details below, and our team will get in touch to explore how
              Global Skills can help meet your talent goals.
            </p>
          ...
          <div className="bg-black text-white p-8 rounded-lg shadow-lg">
            <form className="space-y-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-semibold mb-1">
                    Full Name <span className="text-[#d5f952">*</span>
                  </label>
                  <input
                    type="text"
                    placeholder="Full Name"
                    className="w-full px-3 py-2 rounded-md border border-gray-300 bg-white text-black shadow-sm focus:outline-none focus:ring-2 focus:[#d5f952]"
                  />
                </div>
                <div>
                  <label className="block text-sm font-semibold mb-1">
              ...
              <div>
                <label className="block text-sm font-semibold mb-1">
                  Email <span className="text-[#d5f952">*</span>
                </label>
                <input
                  type="email"
                  placeholder="Email"
              ...
              <button
                type="submit"
                className="w-full bg-[#d5f952] text-black font-semibold py-3 rounded-md hover:bg-[#d5f952] transition"
              >
                Submit
              </button>
            </form>
      ...
      <section className="relative w-full bg-[#d5f952] overflow-hidden">
        {/* Background Wave */}
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center px-6 py-20 md:py-28">
          ...
          <p className="mt-4 text-base md:text-lg text-black">
            We support both enterprise partnerships and individual placement
            journeys.
          </p>
        </div>
      </section>
