                ...
                <div className="w-full md:max-w-[70%] mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center px-6">
                    ...
                    <div>
                        <h1 className="text-3xl md:text-5xl font-bold text-gray-900 leading-tight">
                            Code That Works Isn't <br />Enough Anymore
                        </h1>


                        <p className="mt-4 text-gray-600 leading-relaxed">

                            Your codebase is flooded with AI-generated snippets. What you need are engineers who can sift signal from noise—who can debug, refactor, and ship with judgment. We train programmers who write code they understand and stand by.
                        </p>
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                    ...
                    <div>
                        ...
                        <p className="mt-4 text-gray-600 text-base md:text-lg leading-relaxed">
                            Our programmers are trusted by India’s leading product and service companies.
                        </p>
                ...
                <div className="relative max-w-6xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-2 items-center gap-6">
                    ...
                    <div>
                        ...
                        <p className="text-black text-lg max-w-md">
                            Get engineers who write clean, testable, and context-aware software—even in an AI-first world.
                        </p>
                    </div>
