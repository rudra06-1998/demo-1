    ...
    <div className="bg-white">
      <section className="relative w-full h-56 md:h-78 flex items-center justify-center">
        ...
        <div className="absolute inset-0">
          <img
            src="/assets/imgi_37_3861951.jpg"
        ...
        <div className="w-full md:max-w-[70%] mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center px-6">
          ...
          <div>
            <h1 className="text-3xl md:text-5xl font-bold text-[#333333] leading-tight">
              Code That Works Isn't <br />
              Enough Anymore
            </h1>

            <p className="mt-4 text-gray-600 leading-relaxed">
              Your codebase is flooded with AI-generated snippets. What you need
              are engineers who can sift signal from noise—who can debug,
              refactor, and ship with judgment. We train programmers who write
              code they understand and stand by.
            </p>

            <p className="mt-4 font-semibold text-gray-800">
              Ready to code. Ready to reason. Ready from Day One.
            </p>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Why Programmer Hiring Fails in the AI Era
            </h2>

            <ul className="space-y-4 text-gray-300">
              <li className="flex items-start gap-2">
                <CheckCircle2 className="text-[#d5f952] mt-1" size={22} />
                Candidates rely on AI tools but can't validate results
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="text-[#d5f952] mt-1" size={22} />
                Struggle with debugging generated code
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="text-[#d5f952] mt-1" size={22} />
                Lack architectural understanding to scale solutions
              </li>
            </ul>

            <p className="mt-6 text-gray-400">
              We deliver engineers who work with AI, not depend on it.
            </p>
      ...
      <section className="w-full flex items-center justify-center bg-gray-50 py-10 px-4">
        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-800 text-center">
          Programmers Built for AI-Native Teams
        </h1>
      </section>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <p className="mt-4 text-gray-600 text-base md:text-lg leading-relaxed">
              Our programmers are trusted by India’s leading product and service
              companies.
            </p>
        ...
        <div className="bg-[#d5f952] relative max-w-6xl flex flex-col md:flex-row p-8 md:p-12 mx-auto w-full items-center md:items-start gap-6 rounded-lg min-h-[300px] md:min-h-[300px]">
          ...
          <div className="w-full md:w-2/3 text-center md:text-left">
            <h2 className="text-2xl md:text-4xl font-bold text-black leading-snug">
              Hire Coders Who Can Think, Adapt, and Lead.
            </h2>
            <div className="h-[2px] w-32 bg-black mt-3 mb-5"></div>

            <p className="text-black mt-4">
              Get engineers who write clean, testable, and context-aware
              software—even in an AI-first world
            </p>
          </div>
...
export default HireProgrammers;
