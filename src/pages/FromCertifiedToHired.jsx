    ...
    <div className="bg-white">
        ...
        <div className="w-full md:max-w-[70%] mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center px-6">
          ...
          <div>
            <h1 className="text-3xl md:text-5xl font-bold text-[#333333] leading-tight">
              ...
              <br />— now let us take you the rest of the way.
            </h1>

            <p className="mt-4 text-gray-600 leading-relaxed">
              We help certified engineers get placed in roles that match their
              skills, their stack, and their growth goals.
            </p>

            <button className="mt-6 bg-[#d5f952] hover:bg-[#d5f952] transition text-[#333333] font-semibold px-6 py-3 rounded-md shadow-md">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h2 className="text-3xl md:text-5xl font-bold leading-snug">
              We Know The System <br />
              Often Misplaces Good <br />
              Engineers.
            </h2>
            <p className="mt-6 text-gray-300 text-lg leading-relaxed">
              That’s why Global Skills doesn’t just match you with any job. We
              align you with the right one.
            </p>
            <p className="mt-4 text-gray-300 text-lg leading-relaxed">
              Roles where your skills are valued. Domains that match your
              expertise. Companies where you can grow.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="w-full flex items-center justify-center bg-gray-50 py-10 px-4">
        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-800 text-center">
          Silicon Talent Built for Production Cycles
        </h1>
      </section>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <p className="mt-4 text-gray-600 text-base md:text-lg leading-relaxed">
              For over a decade, Datacipher has helped leading companies across
              BFSI, telecom, IT services, and infrastructure build and secure
              their networks. Enterprises like ICICI Bank, Airtel, HDFC, and
              Tech Mahindra don’t just trust our training — they rely on our
              engineers.
            </p>
            <p className="mt-4 text-gray-600 text-base md:text-lg leading-relaxed">
              And now, through Global Skills, we’re connecting certified
              professionals to the same industry leaders that have trusted us
              for years. This isn’t a pipeline we’re building. It’s one that
              already exists.
            </p>
        ...
        <div className="bg-[#d5f952] relative max-w-6xl flex flex-col md:flex-row p-8 md:p-12 mx-auto w-full items-center md:items-start gap-6 rounded-lg min-h-[300px] md:min-h-[300px]">
          ...
          <div className="w-full md:w-2/3 text-center md:text-left">
            ...
            <p className="text-black mt-4">
              Whether you're already certified or just starting to upskill,
              Global Skills can help you move forward. We connect engineers with
              the roles and the guidance they need to grow.{" "}
            </p>
          </div>
...
export default FromCertifiedToHired;
