...
const AboutUs = () => {
    return (
        <div>
            <div
                className="relative w-full h-[250px] md:h-[350px] flex items-center justify-center bg-cover bg-center"
            >
                {/* Dark overlay */}
                <div

                    style={{ backgroundImage: "url('/assets/imgi_15_computer-network-security-server-room-data-center-d-render-dark-blue-generative-ai.png')" }}
                    ...
                    className="absolute inset-0  bg-opacity-50"></div>
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 leading-relaxed mb-6">
                            ...
                            real-world readiness. We saw it in every enterprise handover, every NOC
                            transition, every unmet SLA and we decided to change it.
                        </p>

                        {/* Button */}
                        <button className="bg-lime-400 hover:bg-lime-500 text-gray-900 font-semibold px-6 py-3 rounded-md shadow-md transition-all flex items-center gap-2">
            ...
            <section className="relative bg-lime-300 py-16 px-6 md:px-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                    ...
                    <div>
                        ...
                        <p className="mt-6 text-gray-600 leading-relaxed">
                            We are powered by <span className="font-semibold text-gray-800">Datacipher Education Services</span>,
                            ...
                            <span className="font-semibold"> Check Point</span>. We’ve trained over
                            500 enterprise teams across telecom, banking, healthcare, and IT services.
                        </p>
                        <p className="mt-4 text-gray-600 leading-relaxed">
                            Now, with Global Skills, we’re channeling that experience into a talent
                            platform where learning leads to hiring and careers start with momentum.
                        </p>

                        {/* CTA Button */}
                        <button className="mt-8 bg-lime-300 hover:bg-lime-400 text-gray-900 font-semibold px-6 py-3 rounded-md shadow-md transition-all">
                            Start Your Tech Career →
                        </button>
                    </div>
                        ...
                        <div className="space-y-6">
                            {offerings.map((item, idx) => (
                                <div key={idx} className="flex items-start gap-4">
                                    {/* Icon */}
                                    <div className="bg-lime-400 text-black text-2xl p-3 rounded-full flex items-center justify-center w-12 h-12">
                                        {item.icon}
                                    </div>
                                    {/* Text */}
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 mb-8">
                            From the classroom to the command line, we help teams and careers scale.
                        </p>
                        <div className="flex gap-4">
                            <button className="bg-lime-400 hover:bg-lime-500 text-black px-6 py-3 rounded-md font-medium transition">
                    ...
                    <div className="flex flex-col gap-6">
                        <div className="flex items-start gap-4 p-6 bg-white shadow-md rounded-xl ">
                            <div className="w-12 h-12 flex items-center justify-center rounded-full bg-lime-300">
                                👥
                            </div>
