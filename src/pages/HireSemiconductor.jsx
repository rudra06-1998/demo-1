                ...
                <div className="w-full md:max-w-[70%] mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center px-6">
                    ...
                    <div>
                        <h1 className="text-3xl md:text-5xl font-bold text-gray-900 leading-tight">
                            Chips Are Getting Smarter.<br /> So Should Your Engineers.
                        </h1>


                        <p className="mt-4 text-gray-600 leading-relaxed">
                            EDA tools are faster. AI-assisted flows are real. But design judgment still wins tape-outs. We provide engineers who don’t just simulate. They optimize, debug, and deliver IP blocks built for production. </p>
            ...
            <section className="relative w-full bg-lime-300 border-red">
                ...
                <div className="relative max-w-6xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-2 items-center gap-6">
                    ...
                    <div>
                       ...
                       Deploy engineers who know how to take a design from spec to signoff. </p>
                    </div>
