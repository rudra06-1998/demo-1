...
const FoundationalTrainingPrograms = () => {
    ...
    return (
        ...
        >
                ...
                <div className="w-full md:max-w-[70%] mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center px-6">
                    ...
                    <div>
                        <h1 className="text-3xl md:text-5xl font-bold text-gray-900 leading-tight">
                            The First Step to Becoming a Network or Security Engineer Starts Here.
                        </h1>


                        <p className="mt-4 text-gray-600 leading-relaxed">
                            No fluff. No skipped steps. Just the solid foundation every great engineer needs
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                    ...
                    <div>
                        ...
                        <p className="text-gray-300 mt-6 leading-relaxed">
                            Too many engineers jump into advanced certifications without the groundwork and get stuck. <br /><br />
                            Our programs change that. <br /><br />
                            We teach the core concepts others assume you already know—so you move forward with clarity, not confusion. <br /><br />
                            If you’re serious about starting a career in networking or cybersecurity, start here. <br /><br />
                        ...
                        <div className="mt-8">
                            <a
                                href="#programs"
                                className="inline-block bg-lime-400 text-black font-semibold px-6 py-3 rounded-lg shadow-lg hover:bg-lime-500 transition"
                            >
            ...
            <div
                className="relative w-full bg-lime-300 bg-cover bg-center bg-no-repeat py-16 px-6"
            >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                    ...
                    <div>
                        ...
                        <p className="mt-6 text-lg text-gray-600 leading-relaxed">
                            For over 15 years, Datacipher has trained engineers for India’s most
                            respected enterprises – <span className="font-medium">Palo Alto, Juniper, Fortinet</span>, and more.
                        </p>
                        <p className="mt-4 text-lg text-gray-600 leading-relaxed">
                            Now under the Global Skills banner, those same experts bring that
                            experience to you. Our foundational programs don’t just teach. They
                            launch careers.
                        </p>
                    </div>
  ...
  <div className="bg-lime-300 relative max-w-6xl flex flex-col md:flex-row p-8 md:p-12 mx-auto w-full items-center md:items-start gap-6 rounded-lg min-h-[300px] md:min-h-[400px]">
    ...
    <div className="w-full md:w-2/3 text-center md:text-left">
      ...
      <p className="text-black mt-4">
        Talk to someone who’s helped hundreds of engineers take their first step into tech.
      </p>
    </div>
