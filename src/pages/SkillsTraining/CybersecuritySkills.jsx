  ...
  return (
    <div className="bg-white">
      <section className="relative w-full h-60 md:h-78 flex items-center justify-center">
        ...
        {/* Text */}
        <h1 className="relative text-3xl md:text-7xl font-bold text-white">
        ...
        <div className="w-full md:max-w-[90%] mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center px-6">
          ...
          <div>
            ...
            <p className="mt-4 text-gray-600 leading-relaxed">
              Today’s threats evolve fast. Firewalls alone won’t cut it. We
              train cyber professionals who understand the entire kill chain
              from detection to response, compliance to recovery. Hands-on,
              alert-driven, and cloud-aware.
            </p>
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-6">
              Our graduates work in SOCs, MSSPs, and enterprise security teams
              across India.
            </p>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <p className="mt-4 text-gray-600 text-base md:text-lg leading-relaxed">
              Our cybersecurity engineers defend India's top enterprises against
