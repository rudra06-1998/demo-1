                ...
                <div className="w-full md:max-w-[70%] mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center px-6">
                    ...
                    <div>
                        ...
                        <p className="mt-4 text-gray-600 leading-relaxed">
                            ...
                            Companies want AI engineers. But most training programs stop at theory. At Global Skills, we don’t. We take learners beyond YouTube tutorials and into real-world AI readiness. From foundational ML to deploying production-grade models, we train talent that delivers.  </p>
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="bg-gray-800 p-8 rounded-xl shadow-lg">
                        ...
                        <p className="mt-6 mb-6 text-gray-400">
                            Most AI programs focus on syntax, not systems. They teach you how to build a model but not how to make it matter in business.
                        </p>
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    <div>
                        <h2 className="text-3xl md:text-5xl font-bold leading-snug text-gray-900">
                            We Fix That. Our AI Curriculum Is Outcome-Driven And Production-Aligned.
                            We Focus On Core Fundamentals, Contextual Learning, And Deployment Readiness.
                        </h2>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex items-start gap-4 p-6 bg-white rounded-lg shadow-md">
                            ...
                            <div>
                                <h3 className="text-lg font-bold text-gray-900">Hands-On From Day 1</h3>
                        ...
                        <div className="flex items-start gap-4 p-6 bg-white rounded-lg shadow-md">
                            ...
                            <div>
                                <h3 className="text-lg font-bold text-gray-900">Built With Enterprise In Mind</h3>
                                <p className="text-gray-600 text-sm">
                                    Everything we teach maps to real-world AI use cases across BFSI, telecom, and SaaS.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-4 p-6 bg-white rounded-lg shadow-md">
                            ...
                            <div>
                                <h3 className="text-lg font-bold text-gray-900">Placement-Ready</h3>
                                <p className="text-gray-600 text-sm">
            ...
            <section className="w-full bg-white py-12 px-6 md:px-12 lg:px-20">
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                    ...
                    <div>
                        ...
                        <p className="mt-4 text-gray-600 text-base md:text-lg leading-relaxed">Backbone Our training division, Datacipher Education Services has delivered enterprise-grade programs to over 500 teams in banking, telecom, infrastructure, and IT services. That same trusted engine now powers Global Skills.Our programmers are trusted by India’s leading product and service companies.
                        </p>
                ...
                <div className="bg-lime-300 relative max-w-6xl flex flex-col md:flex-row p-6 mx-auto w-full items-center md:items-start gap-6 rounded-lg">
                    ...
                    <div className="w-full md:w-2/3 text-center md:text-left">
                        <h2 className="text-2xl md:text-4xl font-bold text-black leading-snug">
                            Whether you're an engineer looking to break into AI or an employer who
                            needs AI talent that’s ready to deploy, Global Skills gets you there.
                        </h2>
                    </div>
